...
type SuccessCopy = ReturnType<
  typeof getSuccessCopy
>;
...
function formatBookingReference(
  bookingId: string,
): string {
  if (!bookingId) {
    return "";
...
function getSuccessCopy(
  ...
  if (
    ...
    return {
      ...
      estimatedTotal:
        "مجموع تخمینی",
      estimatedTotalHint:
        "مبلغ نهایی پس از بررسی کار تأیید می‌شود.",
      reference:
        "شمارهٔ پیگیری",
      submittedAt:
        (value: string) =>
      ...
      stepSubtitle:
        (id: ProcessStepId) =>
          ({
            review:
              "ارائه‌دهنده جزئیات، زمان و آدرس درخواست را بررسی می‌کند.",
            response:
      ...
      goHome:
        "بازگشت به خانه",
      footerHint:
        "می‌توانید وضعیت این درخواست را در بخش رزروها دنبال کنید.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      estimatedTotal:
        "اټکلی ټول",
      estimatedTotalHint:
        "وروستی مبلغ د کار له ارزونې وروسته تاییدېږي.",
      reference:
        "د تعقیب شمېره",
      submittedAt:
        (value: string) =>
      ...
      nextTitle:
        "وروسته څه کېږي؟",
      nextSubtitle:
        "ستاسو غوښتنه به له لاندې مرحلو تېرېږي.",
      stepTitle:
        (id: ProcessStepId) =>
          ({
            review:
      ...
      stepSubtitle:
        (id: ProcessStepId) =>
          ({
            review:
              "خدمت وړاندې کوونکی د غوښتنې جزئیات، وخت او پته ګوري.",
            response:
              "غوښتنه منل یا رد کېږي او ښايي بل وخت وړاندیز شي.",
            conversation:
              "له منلو وروسته نور جزئیات د پیغام له لارې همغږي کولی شئ.",
            service:
              "خدمت وړاندې کوونکی په تایید شوي وخت کې د خدمت لپاره راځي.",
          })[id],
      notificationsTitle:
      ...
      goHome:
        "کورپاڼې ته لاړ شئ",
      footerHint:
        "د دې غوښتنې حالت د رزرفونو په برخه کې تعقیبولی شئ.",
    };
  }
  ...
  return {
    ...
    statusSubtitle:
      "The provider may accept, decline or propose another time.",
    pending:
      "Pending",
    summaryTitle:
      "Request summary",
    ...
    nextTitle:
      "What happens next?",
    nextSubtitle:
      "Your request will move through the following stages.",
    stepTitle:
      (id: ProcessStepId) =>
        ({
          review:
    ...
    goHome:
      "Return home",
    footerHint:
      "You can follow this request from the Bookings section.",
  };
}
